...
var myFavSuperheroes = ['Spiderman', 'Ironman', 'Maskman', 'Batman', 'Cats'];
...
console.log(myFavSuperheroes.splice(-2, 1, 'Parul'));
console.log(myFavSuperheroes);
...
console.log(myFavSuperheroes.splice(2, 0, 'Shubham'));
console.log(myFavSuperheroes);
...
console.log(myFavSuperheroes.splice(3, 2, 'Abhishek'));
console.log(myFavSuperheroes);
...
var superheroUniverse = [
  ['Spiderman', 'Ironman'],
  ['Superman', 'Green Lantern', 'Flash', 'Batman', 'Aquaman'],
];
